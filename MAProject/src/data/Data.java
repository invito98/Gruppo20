...
public class Data {
	...
	public class Example implements Comparable<Example> {
		...
		List<Object> example = new ArrayList<Object>(); // ogni example � una lista di Object
	...
	public Tuple getItemSet(int index) /* restituisce una tupla, vettore di Item, composto di 5 Item, quanto � 
								        * explanatorySet, 
								        */
	{
	...
	public int[] sampling(int k) throws OutOfRangeSampleSize // non modificato perch� dato da lei
	{
	...
	{
		int max;
		int i; // contatore per scandire di quante posizioni l'iteratore dovr� andare avanti nel TreeSet di attribute
		String word;
		...
		while (itr.hasNext())
		{
			word = itr.next(); // da modificare perch� adesso attribute � un TreeSet
		...
		i = 0;
		while (i < max) // ciclo per far andare avanti l'iteratore del TreeSet di j volte, perch� j � l'indice del vettore					
		{
			itr.next();
			i++;
		}
